...
local function MainTab()
    ...
    local REF = net["RE/FishingCompleted"]
    ...
    local REF1 = net["RE/FishingCompleted"]
    ...
    local function cast()
        ...
        task.spawn(function()
            ...
            pcall(function() REF1:FireServer() end)
            task.wait(kDelay)
                    ...
                    if pDiamond.AllDone then
                        ...
                        if turningIn then
                            ...
                            if #tasksToDo > 0 then
                                ...
                                if RF_ChargeFishingRod and RF_RequestFishingMinigameStarted and RE_FishingCompleted and RF_CancelFishingInputs then
                                    local CD, FD, KD = 0.45, 0.7, 0.3
